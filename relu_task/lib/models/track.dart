...
Trac TracFromJson(String str) => Trac.fromJson(json.decode(str));

String TracToJson(Trac data) => json.encode(data.toJson());
...
class Trac {
  ...
  factory Trac.fromJson(Map<String, dynamic> json) => Trac(
